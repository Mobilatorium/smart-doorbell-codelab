...
До того как работать с Android things вам необходимо обновить SDK tools до версии 24 или выше, SDK with Android 7.0 (API 24) или выше. Вы должны:
...
5\. И не забыть освободить ресурсы, когда они нам перестануть быть нужными (в destroy).
```
button.close();
```
